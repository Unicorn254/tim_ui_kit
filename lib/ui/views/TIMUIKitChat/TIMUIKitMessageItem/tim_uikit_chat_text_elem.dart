...
class TIMUIKitTextElem extends StatefulWidget {
  ...
  final TextStyle? otherFontStyle;
...
class _TIMUIKitTextElemState extends TIMUIKitState<TIMUIKitTextElem> {
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    final defaultStyle =
        widget.isFromSelf ? const Color(0xFF5C6CE5) : const Color(0xFF33366E);
        ...
        children: [
          ...
          widget.chatModel.chatConfig.urlPreviewType != UrlPreviewType.none
              ...
              : Text(widget.message.textElem?.text ?? "",
                  softWrap: true,
                  style: widget.isFromSelf
                      ? widget.fontStyle
                      : widget.otherFontStyle ?? const TextStyle(fontSize: 16)),
