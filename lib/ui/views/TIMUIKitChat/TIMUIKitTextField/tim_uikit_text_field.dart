...
class TIMUIKitInputTextField extends StatefulWidget {
  ...
  final String? cloudCustomData; // 云自定义消息字段，只能在消息发送前添加
      ...
      if (model.repliedMessage != null) {
        ...
        MessageUtils.handleMessageError(
            model.sendTextMessage(
                ...
                convID: widget.conversationID,
                convType: convType,
                cloudCustomData: widget.cloudCustomData),
            context);
      }
      textEditingController.clear();
      focusNode.requestFocus();
  ...
  Widget tuiBuild(BuildContext context, TUIKitBuildValue value) {
    ...
    return Selector<TUIChatViewModel, V2TimMessage?>(
        ...
        builder: ((context, value, child) {
          ...
          print("   forbiddenText  ${forbiddenText}   ${showEmojiPanel}");
          ...
          return Column(
            children: [
              ...
              Container(
                ...
                // color: Colors.red,
                child: SafeArea(
                  bottom: showEmojiPanel ? false : true,
                  child: Column(
                    children: [
                      Container(
